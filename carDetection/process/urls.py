...
urlpatterns = [
    # Create
    path('create_intersection/submit', views.create_intersection, name='create_intersection'),
    path('upload_task/submit', views.create_task, name='create_task'),
    path('edit_task/add_loop/<int:task_id>', views.add_loop, name='add_loop'), # not working
    # Read
    ...
    # submit
    path('submit_task/<int:task_id>', views.submit_task, name='submit_task'), # not working
    # test celery
